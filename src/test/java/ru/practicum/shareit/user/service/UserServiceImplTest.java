...
class UserServiceImplTest {
    ...
    @Test
    void createUser_ShouldThrowIncorrectEmailException() {
        user.setEmail("");

        final IncorrectEmailException e = assertThrows(
                IncorrectEmailException.class,
                () -> userService.createUser(user));

        assertThat("Вы не указали email. Для регистрации необходимо указать email", equalTo(e.getMessage()));
    }
